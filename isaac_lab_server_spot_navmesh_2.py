...
# python isaac_lab_server_spot_navmesh_2.py --enable_cameras --scene_folder /home/junzhewu/data/isaac_scenes_v1 --episode_path episodes/test.json
...
goal_position = current_episode["goals"][0]['location']
