# cd pohsun/SG-VLN
# ../IsaacLab/isaaclab.sh -p robot_env/isaac_lab_server_spot_3.py --enable_cameras --scene_path /home/junzhewu/data/isaac_scenes_v1/nvidia_flatten/park_morning/park_morning_edit.usd
...
parser.add_argument("--robot_pos", type=str, default="0,0,0.6", help="Robot initial position (x,y,z)")
