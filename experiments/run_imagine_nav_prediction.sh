#!/bin/bash
# example usage: bash experiments/run_imagine_nav_prediction.sh 2>&1 | tee imagine_nav_prediction.log
export MAGNUM_LOG=quiet HABITAT_SIM_LOG=quiet


# Set experiment name and configuration variables
expname="imagine_nav_prediction"
exp_config="Utility_ObjectRegion_ExploitationSum_ExplorationRaycast_Prediction_BEVRGB.yaml"
dump_dir="dump"
log_file="imagine_nav_prediction.log"
