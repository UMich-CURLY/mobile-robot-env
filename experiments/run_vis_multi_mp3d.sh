...
expname="5_07_mp3d_exploration_axi"
task_config="objectnav_mp3d_rgbd.yaml"
# exp_config="Utility_ObjectOnly_ExploitationOnly_ObservedOnly.yaml"

exp_config="Utility_ObjectOnly_ExplorationOnly_ObservedOnly.yaml"
