...
expname="Utility_ObjectRegion_ExploitationSum_ExplorationRaycast_Prediction_BEVRGB"
exp_config="Utility_ObjectRegion_ExploitationSum_ExplorationRaycast_Prediction_BEVRGB.yaml"
...
# Feature flags
use_imagine_nav_planner=true  # Set to true to enable imagine_nav_planner
...
while [ $restart_count -lt $MAX_RESTARTS ]; do
    ...
    conda run -n ${conda_env_name} --no-capture-output --live-stream ${cmd} 2>&1 | tee -a ${log_file}
