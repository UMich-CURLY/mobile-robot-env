#!/bin/bash
# example usage: bash experiments/run_imagine_nav_planner.sh 2>&1 | tee imagine_nav.log
export MAGNUM_LOG=quiet HABITAT_SIM_LOG=quiet


# Set experiment name and configuration variables
expname="imagine_nav_030_sample100_may2"
exp_config="Utility_ObjectOnly_Exploit_Explore_ObservedOnly.yaml"
dump_dir="dump"
log_file="imagine_nav.log"
