...
def add_vln_args(parser):
    ...
    arg_group.add_argument("--episode_label", type=str, default="test_generator_0", help="Test specific episode label. Format: {scene_id}_{episode_id}), e.g., nv_apartment_0.")
    arg_group.add_argument("--test_scene_id", type=str, default="test_generator", help="Scene id used for task generation.")
