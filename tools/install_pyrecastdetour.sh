...
wget https://github.com/tccoin/PyRecastDetour-Sources/raw/refs/heads/main/dist/PyRecastDetour.cpython-311-x86_64-linux-gnu.so
SITE_PACKAGES=$(python3 -c "import site; print(site.getsitepackages()[0])")
mv PyRecastDetour.cpython-310-x86_64-linux-gnu.so $SITE_PACKAGES/
