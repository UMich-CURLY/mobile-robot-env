...
print(f"{ISAAC_NUCLEUS_DIR}/Environments/Terrains/rough_plane.usd")
...
class RaycasterSensorSceneCfg(InteractiveSceneCfg):
    ...
    ground = AssetBaseCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            # usd_path=f"/home/junzhewu/scratch/isaac_scenes_v1/nvidia/park/apartment_flatten_edit.usd",
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    # create a cube
    cube_path = "/World/Ground/Cube"
    cfg_cube = sim_utils.CuboidCfg(size=[1.0, 1.0, 1.0])
    cfg_cube.func(cube_path, cfg_cube, translation=list([1.,0.,0.]))
