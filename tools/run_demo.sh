...
--enable_cameras \
--scene_path "/home/junzhewu/data/isaac_scenes_v1/nvidia/park/park_morning_edit.usd" \
...
python fix_material.py --usd_path ~/scratch/isaac_scenes_v1/nvidia1/park/park_morning.usd
